...
">
  ...
  <!-- Right Table: fixed width or wider min-width -->
  <table style="
    border-collapse: collapse;
    table-layout: fixed;
    flex-shrink: 0;
...
<table style="border-collapse: collapse; width: 100%; max-width: 400px; margin-bottom: 1em;">
