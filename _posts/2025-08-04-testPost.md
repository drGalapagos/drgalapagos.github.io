...
<table style="border-collapse: collapse; width: 100%; max-width: 900px; table-layout: fixed;">
  <caption style="caption-side: top; text-align: left; font-weight: bold; padding-bottom: 8px;">
    1.1 Identify needs / attributes you care about<br>1.2. Quantify the relative importance of each attribute you care about by dividing 100 points among them. The sum of the scores should = 100 / column.
  </caption>
  <thead>
    <tr>
      <th style="
  ...
  <tbody>
    ...
    <tr>
      <td style="border: 1px solid #ccc; padding: 8px; text-align: left; colspan=3">&nbsp;</td>
    </tr>
    <tr>
